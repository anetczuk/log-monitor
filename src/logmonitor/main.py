...
def state_converter(manager_state: RSSManagerState, tray_manager: TrayManager):
...
def start_with_tray(parameters):
    ...
    tray_manager = TrayManager(rss_start_enabled=start_server, black_theme=black_theme)
